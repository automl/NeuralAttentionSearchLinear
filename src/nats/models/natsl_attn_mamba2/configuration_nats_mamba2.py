...
class NATSMamba2Config(PretrainedConfig):
    """
    ...
    model_type = "nats_mamba"

    def __init__(
        self,
        attn_mode: str = "chunk",
        use_gate: bool = True,
        num_mamba_heads: int = 8,
        num_attn_heads: int = 16,
        head_dim_nats: int =128,
        n_ops: int =2,
        num_nats_head = None,
        ...
        attn_rope_theta: float = 10000.,
        attn_max_position_embeddings: int = None,
        head_dim: int = 64,
        ...
        **kwargs,
        ...
        self.head_dim_nats=head_dim_nats
        ...
        self.n_ops = n_ops
        self.num_nats_head = num_nats_head if num_nats_head is not None else num_mamba_heads
