...
from nats.ops.common.chunk_delta_h import chunk_gated_delta_rule_bwd_dhu, chunk_gated_delta_rule_nats_fwd_h
from nats.ops.common.chunk_o import chunk_bwd_dqkwg, chunk_bwd_dv_local, chunk_fwd_o
from natsl_old.delta_rule import prepare_wy_repr_bwd, prepare_wy_repr_nats_fwd
...
def chunk_delta_rule_nats_fwd(
    ...
    w, u, A = prepare_wy_repr_nats_fwd(
        k=k,
        v=v,
        beta=beta,
