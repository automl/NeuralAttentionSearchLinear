...
from fla.ops.delta_rule.wy_fast import prepare_wy_repr_bwd
...
def recompute_wy_nats_fwd_kernel(
        k,
        v,
        beta,
        w,
...
def recompute_w_u_nats_fwd(
    ...
    recompute_wy_nats_fwd_kernel[grid](
        k,
        v,
        beta,
        w,
...
def prepare_wy_repr_nats_bwd(
    ...
    if keep_wu_as_kv:
        return prepare_wy_repr_bwd(k, v, beta, A, dw, du, cu_seqlens)
